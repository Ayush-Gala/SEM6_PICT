...
if (empty($fname_err) � empty($lname_err) � empty($email_err) � empty($course_err) � empty($city_err) �
empty($state_err)) {
...
<div class="col-lg-6">
<!-- ��� form start �� -->
<form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="bg-light p-4 shadow-sm"
novalidate>
<div class="row">
